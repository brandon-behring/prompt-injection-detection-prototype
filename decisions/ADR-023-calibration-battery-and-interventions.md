...
superseded_by: ["056"]  # narrow supersession: "Platt + Beta deferred" scope sub-decision only; v1.0.8 lands the full 4-calibrator binary battery via eval-toolkit v0.40.0 (ADR-056). ECE 4-variant matrix + Brier decomposition + reliability curves + temperature + isotonic + validation-only-fitting all preserved.
references:
