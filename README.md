...
- **Spec-driven development** — 78 immutable Architecture Decision Records under [`decisions/`](./decisions/) lock methodology choices before code lands.
...
| [`decisions/`](./decisions/) | 78 ADRs documenting methodology + governance |
