...
- **Spec-driven development** --- 75 immutable Architecture Decision Records under [`decisions/`](./decisions/) lock methodology choices before code lands.
...
| [`decisions/`](./decisions/) | 75 ADRs documenting methodology + governance |
...
- **Current state:** [`tree/v1.2.11`](https://github.com/brandon-behring/prompt-injection-detection-prototype/tree/v1.2.11) (2026-05-20) --- live-site source
