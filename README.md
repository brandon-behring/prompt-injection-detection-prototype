...
- **Spec-driven development** — 79 immutable Architecture Decision Records under [`decisions/`](./decisions/) lock methodology choices before code lands.
...
| [`decisions/`](./decisions/) | 79 ADRs documenting methodology + governance |
