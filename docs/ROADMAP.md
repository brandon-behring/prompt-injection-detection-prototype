...
4. Current reviewer-facing site artifacts are `docs/plots/F{1..5}.svg` with provenance sidecars; F6/F7 remain diagnostic/historical code paths after ADR-062 and are not required public site artifacts.
